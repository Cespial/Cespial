...
📍 Medellín, Colombia | 🏗️ Builder at [fourier.dev](https://fourier.dev), [tribai.co](https://tribai.co), [gobia.co](https://gobia.co) & [inplux.co](https://inplux.co) | 🛰️ Remote Sensing Researcher at [EAFIT](https://www.eafit.edu.co) | 🎓 PhD Candidate — [UNAL](https://unal.edu.co) | [![LinkedIn](https://img.shields.io/badge/-LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/cespial/)
...
![Mapbox](https://img.shields.io/badge/-Mapbox-000?style=flat&logo=mapbox&logoColor=white)
![Deck.gl](https://img.shields.io/badge/-Deck.gl-00A9E0?style=flat)
![Pinecone](https://img.shields.io/badge/-Pinecone-000?style=flat&logo=pinecone&logoColor=white)
![Vercel](https://img.shields.io/badge/-Vercel-000?style=flat&logo=vercel&logoColor=white)

> Economist building data platforms, territorial observatories, and geospatial research tools for Colombia. Combining satellite imagery, AI, and full-stack development to solve real problems at the municipal scale. Founder of [Fourier](https://fourier.dev). Member of the [CIIID](https://scienti.minciencias.gov.co/gruplac/jsp/visualiza/visualizagr.jsp?nro=00000000024473) research group (Minciencias-recognized).

🌐 [cespial.github.io](https://cespial.github.io) — personal site & ecosystem graph
...
- 🌴 [uraba_research](https://github.com/Cespial/uraba_research) — Post-conflict land use transitions in Urabá, Antioquia
...
- 📐 [spatial_econometrics](https://github.com/Cespial/spatial_econometrics) — Spatial econometrics exercises & notes (SAR, SEM, GWR, Moran's I)

### 🔭 Observatories & Territorial Data

- 🎓 [sie-medellin](https://github.com/Cespial/sie-medellin) — Sistema de Inteligencia Educativa — Secretaría de Educación de Medellín — Deck.gl + pipeline ETL Python
- 🏙️ [observatorio-laboral-uraba](https://github.com/Cespial/observatorio-laboral-uraba) — City Observatory for Apartadó — 55 tables, 123K+ records, 16 official sources — [observatorio-apartado.vercel.app](https://observatorio-apartado.vercel.app)
- 🏛️ [observatorio-concejo-medellin](https://github.com/Cespial/observatorio-concejo-medellin) — Legislative observatory for Medellín's City Council
- 🗺️ [cartografia-colombia](https://github.com/Cespial/cartografia-colombia) — Mapa catastral interactivo de 1,122 municipios de Colombia — [cartografia-colombia.vercel.app](https://cartografia-colombia.vercel.app)
- 🌐 [gemelo-digital-uraba](https://github.com/Cespial/gemelo-digital-uraba) — Gemelo Digital Logístico — Urabá Banana Belt — [gemelo-digital-uraba.vercel.app](https://gemelo-digital-uraba.vercel.app)
- 🌊 [vigia-cordoba](https://github.com/Cespial/vigia-cordoba) — Sistema de Alertas Tempranas — inundaciones en Córdoba — [vigia-cordoba.vercel.app](https://vigia-cordoba.vercel.app)
- 💼 [marinilla_empleos](https://github.com/Cespial/marinilla_empleos) — Multi-source job scraper for 23 municipalities, 8 sources
...
- 🧮 [tribai](https://github.com/Cespial/tribai) — SuperApp Tributaria Colombia — 40 calculadoras, asistente RAG, doctrina DIAN — [tribai.co](https://tribai.co)
- 🏛️ [gobia](https://github.com/Cespial/gobia) — GovTech platform for Colombian public sector — [gobia.co](https://gobia.co)
- 🎓 [vfpa-jic](https://github.com/Cespial/vfpa-jic) — Financial viability tool for academic programs — Politécnico JIC — [vfpa-jic.vercel.app](https://vfpa-jic.vercel.app)
...
- 📍 [predios-app-demo](https://github.com/Cespial/predios-app-demo) — Identificador inteligente de predios para parqueaderos en capitales colombianas — Mapbox + Supabase PostGIS + Claude AI
- ⚾ [demo-diamante](https://github.com/Cespial/demo-diamante) — Demo Diamante de Béisbol de Medellín — factibilidad parqueaderos + comercio
- 🚌 [plataforma-transporte-skrg](https://github.com/Cespial/plataforma-transporte-skrg) — Cuarto de Control + prefactibilidad parqueadero — ruta Medellín↔SKRG, Oriente Antioqueño
...
- 🤖 [seminario-ia-plataforma](https://github.com/Cespial/seminario-ia-plataforma) — Web platform for AI seminar — course materials & interactive tools
...
- 💎 [Vortice](https://github.com/Cespial/Vortice) — VÓRTICE — Sculptural jewelry, Industrial Dark Luxury — [vortice-jewelry.vercel.app](https://vortice-jewelry.vercel.app)
- ⚡ [techos-espinal-landing](https://github.com/Cespial/techos-espinal-landing) — Tu Página en 48 — express web design service — [tupaginaen48.com](https://tupaginaen48.com)
...
- 🌐 [cespial.github.io](https://github.com/Cespial/cespial.github.io) — Personal portfolio & ecosystem graph — [cespial.github.io](https://cespial.github.io)
...
<p align="center">
  <i>All repos tagged with <a href="https://github.com/Cespial?tab=repositories">topics</a> for easy filtering: <code>research-eafit</code> · <code>flood-risk</code> · <code>observatorio</code> · <code>facturacion</code> · <code>consultoria</code> · <code>educacion</code> · <code>landing-page</code> · <code>govtech</code> · <code>legal-ai</code> · <code>cfe</code></i>
</p>
